...
| 5. 2v2 campaign co-op | Two distinct human-controlled persistent allies, opponent AI, two-team elimination, campaign roster/save/reward integration, and a four-slot arena | Generic mechanics landed asset-free, but EP-D07's admission/session policy has not. The versioned campaign save, roster read-back, consecutive Circuit runner, durable file backend, and rendered four-slot arena have landed. No campaign caller pays or stores the map-derived victory purse. Human admission, pause, authenticated same-seat reconnect, grace handling, and race-safe abandonment remain prerequisites to the playable Endless proof. |
