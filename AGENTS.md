...
- **A FRESH CLONE HAS NO `assets/` EITHER, SO IT SKIPS ~~9~~ 10 — measured
  2026-09-23 at b51ad05** (9 on 2026-09-15, where this line used to say 1 and
  mean the tree above). Besides the archive check, 8 are gated on the extracted
  TEXT pack and 1, since 2690559, on the extracted PROPS pack (the boulder
  test), both gitignored like every other asset. A cloner who measures 10
  against a documented 1 has a correct tree and a wrong document.
